...
public class TelaDeCadastro {
	...
	//Metodo que abre o frame especifico
	public void AbrirTelaDeCadastro()
	{
		frame.setVisible(true);
	}
	
	//Metodo que limpas os campos quando uma accao e finalizada pelo usuario
	...
	private void initialize() {
		...
		JLabel lblNewLabel_2 = new JLabel("MZN");
		...
		txtNomeCalcado.addKeyListener(new KeyAdapter() {
			@Override
			//Desbloqueia o acesso para os campos e botoes do frame
		...
		btnReseta.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//Invoca o metodo para limpar os campos
				limparCampos();
		...
		btnCadastrarCalcado.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//validarPreco e invocado de outra classe para poder validar o preco digitado pelo usuario
				...
				//IF's que verificam a integridade dos dados antes de poder fazer a accao principal solicitada
				if (confirmarPreco.equals("")) 
					JOptionPane.showMessageDialog(null,"Informe O Preco Do Calcado!","ATENCAO - Informacoes Insuficientes!",JOptionPane.WARNING_MESSAGE);
				else if (confirmarData.equals(""))
					JOptionPane.showMessageDialog(null,"Informe A Data De Cadastro Para Este Calcado!","ATENCAO - Informacoes Insuficientes!",JOptionPane.WARNING_MESSAGE);
				else if (confirmarPrecoReal == false) 
					JOptionPane.showMessageDialog(null,"Informe Um Preco Valido!","ATENCAO - InformaCao Invalida!",JOptionPane.WARNING_MESSAGE);
				else if (confirmarDataReal == false)
					JOptionPane.showMessageDialog(null,"Informe Uma Data Valida!","ATENCAO - Informacao Invalida!",JOptionPane.WARNING_MESSAGE);
					...
					JOptionPane.showMessageDialog(null,"Existem Campos Que Ainda Nao Foram Preenchidos!","ATENCAO - Informacoes Insuficientes!",JOptionPane.WARNING_MESSAGE);
				else
				{
					//try catch para tratar qualquer eventual erro de execucao e por isto encerrar o processo de cadastro
					try {
					
						//Trata o preco informado pelo usuario, para que nao possa ocorrer erros de registro
						...
						//Retorna uma resposta do banco de dados, e mostra em uma mensagem caso o calcado tenha sido registrado com sucesso
						...
						JOptionPane.showMessageDialog(null,registroCalcado,"ATENCAO:",JOptionPane.WARNING_MESSAGE);
						
						//Invoca o metodo para limpar os campos logo apos o registro do novo calcado
						limparCampos();
					} 
					catch (Exception e1) 
					{
