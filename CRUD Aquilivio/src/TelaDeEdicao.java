...
public class TelaDeEdicao {
	...
	//Abre o frame especifico e atualiza o JComboBox com o(s) nome(s) do(s) cal�ado(s) no banco de dados
	...
	private void initialize() {
		...
		lblNewLabel_2.setBounds(297, 79, 31, 14);
		...
		txtCalcadosCadastrados.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				...
				else
				{
					...
					//try catch que faz uma requisicao para o banco de dados e retorna com as informacoes do calcado escolhido, e preenche os campos dos mesmos
					try {
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
					//try catch para tratar qualquer eventual erro de execucao e por isto encerrar o processo de edicao
					try {
