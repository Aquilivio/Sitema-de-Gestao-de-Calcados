...
public class TelaDeExclusao {
	...
	//Abre o frame especifico e atualiza o JComboBox com o(s) nome(s) do(s) calcado(s) no banco de dados
	...
	private void initialize() {
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//IF que verifica se o usuario selecionou um calcado antes de poder executar a accao de exclusao
				if (txtCalcadosCadastrados1.getSelectedIndex() == 0) 
					JOptionPane.showMessageDialog(null,"Selecione Um Calcado Para Poder Excluir!","ATENCAO - Informacao Invalida!",JOptionPane.WARNING_MESSAGE);
				else
				{
					//try catch que faz uma requisicao para o banco de dados e retorna uma resposta informando que o calcado foi excluido do banco de dados com sucesso
					try {
